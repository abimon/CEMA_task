        ...
        <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo" href="/">
                    <img src="/logo.png" alt="logo" class="logo-dark" />
                    <img src="/logo.png" alt="logo-light" class="logo-light">
                </a>
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="clients">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="{{route('clients.index')}}">View
                                        Clients</a></li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="programs">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="{{route('programs.index')}}">View
                                        Programs</a></li>
                                <li class="nav-item"> <a class="nav-link" href="" data-bs-target="#createProgramModal" data-bs-toggle="modal">Add
                                        Programs</a></li>
                            </ul>
                        </div>
                    </li>
                ...
                <footer class="footer">
                    <div class="d-sm-flex justify-content-center justify-content-sm-between">
                        <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright &copy;
                            {{date('Y')}} Abobo. All rights reserved. </span>
                    </div>
                </footer>
                <!-- footer ends -->
            </div>
