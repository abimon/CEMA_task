            ...
            <div class="col-md-12 grid-margin">
                <div class="card">
                    ...
                    <div class="d-md-flex row m-0 quick-action-btns" role="group" aria-label="Quick action buttons">
                        ...
                        <div class="col-sm-6 col-md-3 p-3 text-center btn-wrapper">
                            <a href="{{ route('programs.create') }}" style="text-decoration: none;">
                        ...
                        <div class="col-sm-6 col-md-3 p-3 text-center btn-wrapper">
                            <a href="{{ route('programs.index') }}" style="text-decoration: none;">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row report-inner-cards-wrapper">
                            <div class="col-md -6 col-xl report-inner-card" href="{{ route('clients.index') }}">
                            ...
                            <div class="col-md-6 col-xl report-inner-card" href="{{ route('programs.index') }}">
                                <div class="inner-card-text">
                                    <span class="report-title">PROGRAMS</span>
                                    <h4>{{App\Models\Program::count()}}</h4>
                                    <span class="report-count"> +{{App\Models\Program::where('created_at', '>=', Carbon\Carbon::now()->subDays(1))->count()}} Program today</span>
                                </div>
                            ...
                            <div class="col-md-6 col-xl report-inner-card">
                                <div class="inner-card-text">
                                    <span class="report-title">ENROLLMENTS</span>
                                    <h4>{{App\Models\Enroll::count()}}</h4>
                                    <span class="report-count"> +{{App\Models\Enroll::where('created_at', '>=', Carbon\Carbon::now()->subDays(1))->count()}} Enrollment(s) today</span>
                                </div>
